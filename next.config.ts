        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https: blob: data: *.clerk.accounts.dev *.clerk.services challenges.cloudflare.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "font-src 'self' https://fonts.gstatic.com",
              "img-src 'self' data: blob: https:",
              // Added Google's domains to connect-src
              "connect-src 'self' *.clerk.accounts.dev *.clerk.services *.convex.cloud https://api.github.com https://github.com accounts.google.com *.googleapis.com",
